...
public class NewQuestionPage extends AppCompatActivity {
    private DBHelper dbHelper = new DBHelper(NewQuestionPage.this);
    ...
    private void checkQuestionValid(){
        ...
        if(questionAndAnsList.get(0).equals("")) {
            ...
            errorLabel.setText("The Question Can't Have A Blank Answer");
        }else if(questionAndAnsList.get(0).equals("null") || questionAndAnsList.get(0).equals("Null")){
            //This runs if the question EditView is null
            errorLabel.setText("The Question Can't Be Null");
        }else {
            ...
            for (int x = 1; x < questionAndAnsList.size();x++){
                //This if statement is used to check if any of the answers are blank, and none of the answers are null
                if (questionAndAnsList.get(x).equals("")){
                    anAnswerIsBlank = true;
                    break;
                }else if (questionAndAnsList.get(x).equals("null") || questionAndAnsList.get(x).equals("Null")){
                    anAnswerIsNull = true;
                    break;
                }
            }
                        ...
                        if (exactQuestionAlreadyExists == true) {
                            ...
                            if (questionColour == "None") {
                                ...
                                if (questionAlreadyExists == true) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(NewQuestionPage.this);
    ...
    public void addNewQuestionToDB(String passedQuestionColour){
        ...
        Toast.makeText(NewQuestionPage.this, "New Question Added", Toast.LENGTH_SHORT).show();
        //Changes the page back to the questions page
        Intent intent = new Intent(NewQuestionPage.this, QuestionsPage.class);
    ...
    private void setupRecyclerView(){
        ...
        adapter = new IndividualQuestionAdapter(NewQuestionPage.this, questionAndAnsList, charLimitNum, questionLimitNum, false);
